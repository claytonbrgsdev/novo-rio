...
from ..crud_async.player_profile import (
...
async def create_profile_endpoint(
    ...
    existing_profile = await get_player_profile_by_user_id(db, user_id)
    ...
    # Create the profile
    return await create_player_profile(db, profile_in)
...
async def get_profile_endpoint(
    ...
    """
    profile = await get_player_profile_by_user_id(db, user_id)
...
async def update_profile_endpoint(
    ...
    updated_profile = await update_player_profile(db, user_id, profile_update)
