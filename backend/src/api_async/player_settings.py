...
from ..crud_async.player_settings import (
...
async def create_settings_endpoint(
    ...
    existing_settings = await get_player_settings_by_user_id(db, user_id)
    ...
    # Create the settings
    return await create_player_settings(db, settings_in)
...
async def get_settings_endpoint(
    ...
    """
    settings = await get_player_settings_by_user_id(db, user_id)
...
async def update_settings_endpoint(
    ...
    updated_settings = await update_player_settings(db, user_id, settings_update)
